...
#### Learn to explain the four principles of the 'this' keyword and demonstrate each explanation with an example of their uses
...
[Link to Codepen From Video](https://codepen.io/lambdaschool/pen/vQOLGO)
