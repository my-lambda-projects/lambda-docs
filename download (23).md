...
#### Learn to bootstrap a React application with Create React App

To jump into React development, we will learn the tools you can use to get your projects started quickly and efficiently.
...
Here is the [documentation](https://reactjs.org/docs/create-a-new-react-app.html#create-react-app) of the new process, and it is also explained below.

Note, however, that if you have installed create-react-app globally, you will need to uninstall it with npm uninstall -g create-react-app before running the new command to prevent npm from running the outdated version of create-react-app installed on your computer.
...
1.  **Study the file structure.** Your file structure (as of this CRA release) will look like this:

![file-struct](https://tk-assets.lambdaschool.com/0e940b71-7768-4f60-a8b4-3b761f0fde82_ScreenShot2020-03-06at15.41.43.png)
...
1.  **Add your own code!** Inside of `App.js`, make modifications to make this component “yours.”
...
<img src="https://tk-assets.lambdaschool.com/768cf7a6-a21d-49ff-9419-fae5b329b1b5_ScreenShot2018-09-11at8.49.13PM.png" width="400" alt="drawing" />
...
<img src="https://tk-assets.lambdaschool.com/55ce1f76-51e9-436b-bde8-3eb315c919e9_ScreenShot2018-09-11at8.49.26PM.png" width="400" alt="drawing" />
