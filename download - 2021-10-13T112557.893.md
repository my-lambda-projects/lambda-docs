...
-   know about common anti-patterns and how to avoid or mitigate them
-   understand commonly used design patterns
...
-   [Video: Software Design Patterns](https://youtu.be/MDfJhxSHY0w)

## <a href="#learn" id="learn" class="anchor"><span class="octicon octicon-link"></span></a>Learn

#### Learn to know about common anti-patterns and how to avoid or mitigate them

------------------------------------------------------------------------

#### Learn to understand commonly used design patterns

##### Dig Deeper

-   [Software Design Patterns](https://en.wikipedia.org/wiki/Software_design_pattern)  
    A fairly canonical list of many software design patterns (common and less common)
-   [Anti-patterns](https://en.wikipedia.org/wiki/Anti-pattern)  
    A list of anti-patterns (recurring problems in software development)
...
-   [All previous recordings](/archive/CSAnnex/module/recgVHqW0RShuQn1Z)
