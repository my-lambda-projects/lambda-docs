...
#### Learn to describe what a component is and identify different parts of a component
...
Many times, we will receive some data, such as an array, and we will need to create a new component for each item in that data. We can utilize array methods to achieve this.
