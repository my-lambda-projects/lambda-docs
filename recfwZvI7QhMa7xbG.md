...
## [User Interface](../module/recl0IyzS2Vl89lZa)
...
## [User Interface II](../module/recGvXyWT6AvGtMHR)
...
- Student should be able to use CSS display properties to build user interface
- Student should be able to implement a CSS reset and understand why it’s important for cross browser development

## [User Interface III](../module/recaVbBZhh8BTyMdM)
...
- Student should be able to demonstrate understanding of flex item properties in flexbox

## [Sprint Challenge - User Interface and Responsive Web Sprint Challenge](https://github.com/LambdaSchool/Sprint-Challenge--User-Interface)

This challenge will cover all of the objectives from the sprint. You will be creating a fully responsive website from several design files. Each design file comes with a set width. Those widths will be used by you to compare your work against the design.
