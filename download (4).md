...
Dress for the job you want, not the job you have. When interviewing, dress a step up from what you’d wear to work every day.
...
#### Learn to learn what HTML is and what it is used for in Web Development
...
See the Pen [PreCourse tag levels Tutorial](https://codepen.io/lambdaschool/pen/961cd3dbdd87725892b6d6415f547925) by Lambda School ([@lambdaschool](https://codepen.io/lambdaschool)) on [CodePen](https://codepen.io).
...
Next, let’s grab the subtitle “Higher learning. Higher earning” and “your new tech career starts here” and place them in `<h2>` heading and `</h2>` closing tags.
...
See the Pen [PreCourse attributes](https://codepen.io/lambdaschool/pen/5d24a9de4455e40d4a5dc5c628812326) by Lambda School ([@lambdaschool](https://codepen.io/lambdaschool)) on [CodePen](https://codepen.io).
...
See the Pen [PreCourse Style](https://codepen.io/lambdaschool/pen/4918a680ea2327cb02fc888270483aa0) by Lambda School ([@lambdaschool](https://codepen.io/lambdaschool)) on [CodePen](https://codepen.io).
...
See the Pen [PreCourse Style w divs](https://codepen.io/lambdaschool/pen/061349c6b346983da14bdba6939809a8) by Lambda School ([@lambdaschool](https://codepen.io/lambdaschool)) on [CodePen](https://codepen.io).
