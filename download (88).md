...
Package managers allow developers to install several code dependencies with just a few commands. We will be using npm as our go-to package manager here at Lambda.
...
Occasionally you will need simple math operators in your CSS. You can use `+`,`-`,`*`, and `/` on any number, color, or variable. Be careful, operators take units into account and will convert numbers before adding. To find out what unit to expect, you need to look at the leftmost stated unit type.
