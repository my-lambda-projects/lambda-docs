...
-   **Concurrency** and **Parallelism**: The CPU can do multiple things at once through a variety of mechanisms, including having multiple cores, or other features such as *pipelining* or *hyperthreading* (both out of scope for us.)
...
-   [Ars Technica: Gangnam Style overflows INT\_MAX, forces YouTube to go 64-bit](https://arstechnica.com/information-technology/2014/12/gangnam-style-overflows-int_max-forces-youtube-to-go-64-bit/)  
