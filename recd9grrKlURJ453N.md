...
## [Iterative Sorting](../module/reck76SPX26beGSqE)
...
- Student should be able to describe the differences between Linear and Binary Searching algorithms
- Student should be able to distinguish when to use, classify the performance, and implement code to conduct classic iterative sorting algorithms

## [Recursive Sorting](../module/reccRh9h6ccXghfA4)
...
- Student should be able to write a recursive solution to a problem
- Student should be able to distinguish when to use, classify the performance, and implement code to conduct classic recursive sorting algorithms

## [A First-Pass Solution](../module/recrCuZQMVI6LvxhD)
...
- Student should be able to interpret a problem, specification, or diagram and construct a plan for implementing a solution in code
- Student should be able to implement a first-pass solution after selecting from a naïve, brute-force, or greedy approach

## [Writing Better Solutions](../module/recsvJCzPlM2X63ZX)

#### Objectives:

- Student should be able to evaluate a first-pass solution and reflect on its validity to decide if the solution needs revision
- Student should be able to apply techniques such as memoization or heuristics to improve an existing first-pass solution
