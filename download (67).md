...
- # An error occurred.
  ...
  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=6kkMjlLdIOw), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=48qQCRv0dLQ), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=rtSnWax4YAY), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=Z7ekXNCcq68), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=eHGJK5TM7MY), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=Ct1HAta7Zho), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=1TSVzK4BB3I), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=d0AO1XEMyhU), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=gFl7219duyI), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=OnVzOk6L15Y), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=9qCWcui38xI), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=hXUb7k2IiHs), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=XU540m0LuZo), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=X1aOBVxJ8MQ), or enable JavaScript if it is disabled in your browser.

- # An error occurred.

  [Try watching this video on www.youtube.com](https://www.youtube.com/watch?v=toE9CAwedPU), or enable JavaScript if it is disabled in your browser.

## <a href="#learn" id="learn" class="anchor"><span class="octicon octicon-link"></span></a>Learn

#### Learn to install Python 3 on their local machine, run the interactive prompt in the terminal, and run Python files through the interpreter
...
1.  Go to [http://brew.sh/](https://brew.sh/) and select the Homebrew bootstrap code under “Install Homebrew” and copy the complete command to your clipboard.
...
#### Learn to use a print statement

##### Overview

Python is simple, and the syntax is straightforward. The most uncomplicated possible directive to write in Python is the `print` directive. The `print` function prints out a line and includes a newline.

##### Follow Along

To print a string in Python, you write:
...
#### Learn to use white space to denote blocks

##### Overview

In Python, to denote a block, whitespace is used instead of some other character. Both tabs and spaces will work, but the standard is to use four spaces.

##### Follow Along

For example, for an if statement in Python, you would write the following:
...
#### Learn to use basic types (integers, floats, strings) and interact with those types
...
#### Learn to perform basic list operations
...
#### Learn to use basic operators to perform mathematical calculations and interact with strings and lists
...
#### Learn to create formatted strings
...
#### Learn to perform basic string operations
...
#### Learn to evaluate conditional expressions and use boolean operators to control flow
...
#### Learn to use for and while loops and break and continue statements
...
#### Learn to use list comprehensions
...
#### Learn to create user-defined functions and call them
...
#### Learn to create user-defined classes and interact with instances of those classes
...
#### Learn to perform basic dictionary operations
...
- [All previous recordings](/archive/cs/module/recHNgXTaBpnn052p)
