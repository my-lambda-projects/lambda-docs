...
All modern languages have the concept of _functions_ that you can call, have perform some task, and then return to where you were before you left off. At the assembly level, functions are implemented using a simple call/return mechanism that is commonly referred to as a _subroutine_.
