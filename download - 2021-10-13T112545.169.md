...
-   understand randomness and its applications
...
#### Learn to understand randomness and its applications

Randomness has a variety of uses, from algorithm optimization to seeding with robust test data. Understanding the applications of randomness and pseudo-randomness will allow students to utilize randomness as an effective tool when it is appropriate.
...
Traverse a large maze using graph traversal techniques.

[GitHub Repo](https://github.com/LambdaSchool/Graphs/tree/master/projects/adventure)
...
-   **[Graphs III for CS35 w/ Beej Jorgensen](https://youtu.be/2bYteFxobwM)**

    Day 3 of Graphs

-   [All previous recordings](/archive/CS/module/reck4RVWsg82eiYPZ)

### Demonstrate Mastery

To demonstrate mastery of this module, you need to complete and pass a code review on each of the following:

-   Guided Project: Maze Traversal
