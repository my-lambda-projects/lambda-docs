...
## [Responsive Design I](../module/recuDrqSGpWcepCMs)
...
- Student should be able to build responsive layouts using an effective approach

## [Responsive Design II](../module/recE3IqPtDxaVI0DW)

Understanding the problem vs fixing a problem are two different things. We aim to fix the problems presented by the thousands of devices we are required to develop for. This module will address techniques that will push your ability to code a responsive website or app further.
...
## [Preprocessing I](../module/reculyBhIYkuoBRqh)
...
Beyond that is just syntax and study of the documentation. With practice, preprocessing can increase productivity and decrease errors. Once you learn how to use a preprocessor, you won’t want to use CSS without it ever again!

#### Objectives:

- Student should be able to install Node on Windows (if needed)
- Student should be able to install Node on Mac (if needed)
- Student should be able to implement variables, mixins, nesting, nested at-rules in LESS

## [Preprocessing II](../module/rec1hRu3bO6L0uxn2)
...
- Student should be able to create parametric mixins, use functions, and incorporate escaping
- Student should be able to create a master LESS file and use importing to create a project.

## [Sprint Challenge - Advanced CSS Sprint Challenge](https://github.com/LambdaSchool/Sprint-Challenge--Advanced-CSS)
