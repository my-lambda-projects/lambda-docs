...
## [React Router I](../module/rec2TJ1vrdfcnx2EG)
...
- Student should be able to use the \`Link\` component to navigate between routes
- Student should be able to create dynamic routes using URL parameters and the \`match\` object

## [React Router II](../module/recYkF1FDilIedmwX)
...
- Student should be able to pass data to components rendered by React Router via the render prop
...
## [Sprint Challenge - React (SPA) w/ Routes and Hooks](https://github.com/LambdaSchool/Sprint-Challenge-Single-Page-Apps)

Students will build out a Single Page Application with client side routing & React Hooks.
