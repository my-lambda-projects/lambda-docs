...
## [DOM I](../module/rectn5PUU5ubcQkPu)
...
## [DOM II](../module/recJWv3RIfa4NFXbn)
...
## [Components I](../module/rec847sNXZX9CVDNl)
...
-   Student should be able to describe what a component is and identify different parts of a component
-   Student should be able to write a function that utilizes createElement and returns a new DOM element
-   Student should be able to iterate over a list of data creating a new component for each item and attaching that component to the DOM

## [Components II](../module/recd6kDKS6eMapSRq)
...
-   Student should be able to understand and utilize asynchronous Javascript and Promises
-   Student should be able to understand HTTP requests and get data from a server using axios
-   Student should be able to iterate over a list of data received from a server, creating a set of components and adding them to the DOM
