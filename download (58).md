...
-   See the Github Repository [https://github.com/LambdaSchool/java-sampleemps.git/sampleemps\_model](https://github.com/LambdaSchool/java-sampleemps.git) for the code used in the objective.
...
-   See the Github Repository [https://github.com/LambdaSchool/java-sampleemps.git/sampleemps\_model](https://github.com/LambdaSchool/java-sampleemps.git)t for the code used in the objective.
...
Using restaurants with menus as our model, we explore CRUD operations related to model data. We will start with the crudyrestaurants\_initial application found in the repo
