...
We will learn what events and event listeners are, and you will be able to explain those concepts. This is the foundation for adding dynamic usability to our sites.
...
Event propagation can cause many headaches when dealing with events. It is best to learn how to recognize this feature, and how to properly prevent it from happening, when need be.
